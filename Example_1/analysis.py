...
Preface = {"Cell Phones & Accessories": "随着现代科技的进步发展，各式各样的移动设备正逐渐成为人们学习工作生活中的必需品，对于跨境电商而言，手机及其附件的市场规模同样不容小觑。",

"Health & Personal Care": "健康，向来是人类生活追求的永恒主题之一，而健康及个人护理类商品，也是跨境电商市场中的重要组成部分。",

"Pet Supplies": "随着人们生活水平的提高与社会压力的加大，养一只小宠物作为自己的动物伴侣正成为当今时代下时髦的减压方式，由此也促进了宠物用品相关跨境电商市场的产生与发展。",

"Kitchen & Dining": "幸福美好的家居生活离不开各式各样厨具用品的陪伴，随着网络科技的发展，人们通过跨境电商平台来选购一系列的厨房餐饮工具，也逐渐成为了生活中常见的现象。",

"Sports & Outdoors": "近年来，伴随着社会科技水平的提高与工业设计的人性化发展，各式各样的户外运动产品层出不穷，而通过网购来获得最新潮的户外运动装置，也成为了许多时尚人士的不二之选。",

"Tools & Home Improvement": "家装灯具、五金配件以及各类家电，是现代人家居生活中必不可少的工具助手，同时也是跨境电商市场中的重要组成部分。",

"Clothing, Shoes & Jewelry": "衣着与装饰，作为人们物质生活中必不可少的一环，一直是广大网购爱好者最为关心的品类之一，而在跨境电商平台中，各式各样的衣着与装饰类商品争奇斗艳，也形成了一道亮丽的风景线。",

"Toys & Games": "说起玩具，大多数人也许首先会联想到家中的小孩或是自己童真的孩提时代，而随着生活节奏的加快与社会压力的增大，如今，通过网购的方式在第一时间淘来一些新奇的玩具也成为了一部分时髦人士的解压方式。",

"Office Products": "档案夹、订书机、签字笔等形形色色的办公用品，是现代人日常工作中必不可少的辅助工具。通过电商平台来购买这些工作中的得力助手，也成为了当今时代下一部分企业或是个人节省时间、提高工作效率的方法之一。"
}
...
class Product(object):
    ...
    def read_data(self):
        df = pd.read_pickle(filepath+bd+date+'_product.pkl')
        # 修复价格显示百倍
...
class TopList(object):
    ...
    def read_data(self):
        df_ = pd.read_pickle('{}{}{}_{}.pkl'.format(filepath, bd, date, self.list_name))
        df = pd.merge(df_, product.data, how='left', on = 'product_id')
        return df
...
lists = {'Best Seller':TopList('bestsellers'), 
         'Hot New Releases':TopList('hotnewreleases'), 
         'Movers & Shakers':TopList('moversandshakers')}
